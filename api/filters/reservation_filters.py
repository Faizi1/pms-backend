...
class ReservationFilter(filters.FilterSet):
    ...
    class Meta:
        model = Reservation
        fields = ['user', 'spot', 'start_time_after', 'start_time_before', 'end_time_after', 'end_time_before', 'is_active', 'created_by', 'updated_by', 'created_at_after', 'created_at_before', 'updated_at_after', 'updated_at_before']