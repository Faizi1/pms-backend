...
class ChargingRequestFilter(filters.FilterSet):
    ...
    request_time_after = filters.DateTimeFilter(field_name='request_time', lookup_expr='gte')
    request_time_before = filters.DateTimeFilter(field_name='request_time', lookup_expr='lte')
    ...
    class Meta:
        ...
        fields = ['user', 'spot', 'bot_id', 'car_model', 'battery_capacity_min', 'battery_capacity_max', 'duration_min', 'duration_max', 'status', 'request_time_after', 'request_time_before', 'created_by', 'updated_by', 'created_at_after', 'created_at_before', 'updated_at_after', 'updated_at_before']
