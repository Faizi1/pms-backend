...
class RoleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Role
        fields = ('id', 'name', 'code_name', 'permissions', 'permissions_id', 'created_at', 'updated_at', 'created_by',
                  'updated_by', 'created_by_data', 'updated_by_data')
        read_only_fields = ('created_at', 'updated_at', 'created_by_data', 'updated_by_data')
